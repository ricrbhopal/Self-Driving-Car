...
class window(QtWidgets.QMainWindow):
   def __init__(self):
      ...
      self.setWindowTitle("Self Driving Car App | www.ricr.in")
      ...
      self.label3=QtWidgets.QLabel("e.g. http://100.95.199.102:8080/shot.jpg",self)
   ...
   def forward(self):
      ...
      io.imsave(r'C:\Users\hpvic\mohit_payasi\deep_learnig\poteto\new_self_driving_car\testsdc\forward_'+str(fnum)+".jpg",img)
      self.image.setPixmap(QtGui.QPixmap(r'C:\Users\hpvic\mohit_payasi\deep_learnig\poteto\new_self_driving_car\testsdc\forward_'+str(fnum)+".jpg"))
      fnum=fnum+1
   ...
   def right(self):
      ...
      self.s.write(b'r')
      img=io.imread(self.url)
      io.imsave(r'C:\Users\hpvic\mohit_payasi\deep_learnig\poteto\new_self_driving_car\testsdc\right_'+str(rnum)+".jpg",img)
      self.image.setPixmap(QtGui.QPixmap(r'C:\Users\hpvic\mohit_payasi\deep_learnig\poteto\new_self_driving_car\testsdc\right_'+str(rnum)+".jpg"))
      rnum=rnum+1
   ...
   def left(self):
      ...
      self.s.write(b'l')
      img=io.imread(self.url)
      io.imsave(r'C:\Users\hpvic\mohit_payasi\deep_learnig\poteto\new_self_driving_car\testsdc\left_'+str(lnum)+".jpg",img)
      self.image.setPixmap(QtGui.QPixmap(r'C:\Users\hpvic\mohit_payasi\deep_learnig\poteto\new_self_driving_car\testsdc\left_'+str(lnum)+".jpg"))
      lnum=lnum+1
   ...
   def backward(self):
      ...
      self.s.write(b'b')
      img=io.imread(self.url)
      io.imsave(r'C:\Users\hpvic\mohit_payasi\deep_learnig\poteto\new_self_driving_car\testsdc\backward_'+str(bnum)+".jpg",img)
      self.image.setPixmap(QtGui.QPixmap(r"C:\Users\hpvic\mohit_payasi\deep_learnig\poteto\new_self_driving_car\testsdc\backward_"+str(bnum)+".jpg"))
      bnum=bnum+1
   ...
   def stopdir(self):
      ...
      self.s.write(b's')
      img=io.imread(self.url)
      io.imsave(r'C:\Users\hpvic\mohit_payasi\deep_learnig\poteto\new_self_driving_car\testsdc\stop_'+str(snum)+".jpg",img)
      self.image.setPixmap(QtGui.QPixmap(r'C:\Users\hpvic\mohit_payasi\deep_learnig\poteto\new_self_driving_car\testsdc\stop_'+str(snum)+".jpg"))
      snum=snum+1
